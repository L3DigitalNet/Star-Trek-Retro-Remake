...
"   ")
        ...
        self.rightDockLayout.setObjectName(u"rightDockLayout")
        ...
        self.shipNameLabel.setStyleSheet(u"font-size: 16px; font-weight: bold; color: #4CAF50;")
        ...
        self.hullLabel.setObjectName(u"hullLabel")
        ...
        self.shieldsLabel.setObjectName(u"shieldsLabel")
        ...
        self.shieldsProgressBar.setStyleSheet(u"QProgressBar::chunk { background-color: #2196F3; }")
        ...
        self.energyProgressBar.setStyleSheet(u"QProgressBar::chunk { background-color: #FF9800; }")
        ...
        self.actionsLabel.setStyleSheet(u"font-weight: bold;")
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(shortcut)
        self.actionGalaxyMode.setText(QCoreApplication.translate("MainWindow", u"Galaxy Map", None))
#if QT_CONFIG(tooltip)
        self.actionGalaxyMode.setToolTip(QCoreApplication.translate("MainWindow", u"Switch to Galaxy Map view", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionGalaxyMode.setShortcut(QCoreApplication.translate("MainWindow", u"F1", None))
#endif // QT_CONFIG(shortcut)
        self.actionSectorMode.setText(QCoreApplication.translate("MainWindow", u"Sector Map", None))
#if QT_CONFIG(tooltip)
        self.actionSectorMode.setToolTip(QCoreApplication.translate("MainWindow", u"Switch to Sector Map view", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionSectorMode.setShortcut(QCoreApplication.translate("MainWindow", u"F2", None))
#endif // QT_CONFIG(shortcut)
        self.actionCombatMode.setText(QCoreApplication.translate("MainWindow", u"Combat Mode", None))
#if QT_CONFIG(tooltip)
        self.actionCombatMode.setToolTip(QCoreApplication.translate("MainWindow", u"Switch to Combat view", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionCombatMode.setShortcut(QCoreApplication.translate("MainWindow", u"F3", None))
#endif // QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionZoomIn.setShortcut(QCoreApplication.translate("MainWindow", u"+", None))
#endif // QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionZoomOut.setShortcut(QCoreApplication.translate("MainWindow", u"-", None))
#endif // QT_CONFIG(shortcut)
        self.actionZoomReset.setText(QCoreApplication.translate("MainWindow", u"Reset Zoom", None))
#if QT_CONFIG(tooltip)
        self.actionZoomReset.setToolTip(QCoreApplication.translate("MainWindow", u"Reset zoom to default level", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionZoomReset.setShortcut(QCoreApplication.translate("MainWindow", u"0", None))
#endif // QT_CONFIG(shortcut)
        ...
        self.phaseLabel.setText(QCoreApplication.translate("MainWindow", u"Phase: Movement", None))
        self.actionPointsLabel.setText(QCoreApplication.translate("MainWindow", u"AP: 5", None))
        ...
        self.rightDock.setWindowTitle(QCoreApplication.translate("MainWindow", u"Ship Status", None))
        self.shipNameLabel.setText(QCoreApplication.translate("MainWindow", u"U.S.S. Enterprise", None))
        self.hullLabel.setText(QCoreApplication.translate("MainWindow", u"Hull Integrity:", None))
        self.hullProgressBar.setFormat(QCoreApplication.translate("MainWindow", u"%p%", None))
        self.shieldsLabel.setText(QCoreApplication.translate("MainWindow", u"Shields:", None))
        ...
        self.energyProgressBar.setFormat(QCoreApplication.translate("MainWindow", u"%p%", None))
        self.coordinatesLabel.setText(QCoreApplication.translate("MainWindow", u"X: 0, Y: 0, Z: 0", None))
        self.sectorLabel.setText(QCoreApplication.translate("MainWindow", u"Sector: Unknown", None))
        self.actionsLabel.setText(QCoreApplication.translate("MainWindow", u"Ship Actions:", None))
        self.moveButton.setText(QCoreApplication.translate("MainWindow", u"Move Ship", None))
#if QT_CONFIG(tooltip)
        self.moveButton.setToolTip(QCoreApplication.translate("MainWindow", u"Move ship to a new location (1 AP)", None))
#endif // QT_CONFIG(tooltip)
        self.rotateButton.setText(QCoreApplication.translate("MainWindow", u"Rotate Ship", None))
#if QT_CONFIG(tooltip)
        self.rotateButton.setToolTip(QCoreApplication.translate("MainWindow", u"Change ship orientation (1 AP)", None))
#endif // QT_CONFIG(tooltip)
        self.fireButton.setText(QCoreApplication.translate("MainWindow", u"Fire Weapons", None))
#if QT_CONFIG(tooltip)
        self.fireButton.setToolTip(QCoreApplication.translate("MainWindow", u"Fire phasers (1 AP) or torpedoes (2 AP)", None))
#endif // QT_CONFIG(tooltip)
        self.scanButton.setText(QCoreApplication.translate("MainWindow", u"Scan Target", None))
#if QT_CONFIG(tooltip)
        self.scanButton.setToolTip(QCoreApplication.translate("MainWindow", u"Scan selected target for details (1 AP)", None))
#endif // QT_CONFIG(tooltip)
        self.evasiveButton.setText(QCoreApplication.translate("MainWindow", u"Evasive Maneuvers", None))
#if QT_CONFIG(tooltip)
        self.evasiveButton.setToolTip(QCoreApplication.translate("MainWindow", u"Execute evasive pattern (1 AP)", None))
#endif // QT_CONFIG(tooltip)
        self.dockButton.setText(QCoreApplication.translate("MainWindow", u"Dock at Station", None))
#if QT_CONFIG(tooltip)
        self.dockButton.setToolTip(QCoreApplication.translate("MainWindow", u"Initiate docking procedure", None))
#endif // QT_CONFIG(tooltip)
        self.hailButton.setText(QCoreApplication.translate("MainWindow", u"Hail Ship", None))
#if QT_CONFIG(tooltip)
        self.hailButton.setToolTip(QCoreApplication.translate("MainWindow", u"Open communication channel", None))
#endif // QT_CONFIG(tooltip)
    # retranslateUi
